...
function initValue(obj) {
	...
	switch (obj.wanInfo[0].typeInfo) {
		case "0" :
			...
			$("#mac-speed").text('当前速率：1000M全双工');
			break;
		case "1" :
			$("#wanSpeedInfo").removeClass('none');
			$("#mac-speed").text('当前速率：10M全双工');
			break;
		case "2" :
			$("#wanSpeedInfo").removeClass('none');
			$("#mac-speed").text('当前速率：10M半双工');
			break;
		case "3" :
			$("#wanSpeedInfo").removeClass('none');
			$("#mac-speed").text('当前速率：100M全双工');
			break;
		case "4" :
			$("#wanSpeedInfo").removeClass('none');
			$("#mac-speed").text('当前速率：100M半双工');
			break;
		case "5" :
			$("#wanSpeedInfo").removeClass('none');
			$("#mac-speed").text('当前速率：未连接');
			break;
		default :
