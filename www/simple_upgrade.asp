...
function submitSystemUpgrade(){  
	if (document.frmSetup.upgradeFile.value == "") {
		alert(_("Please select upgrade file first!"));
		return ;
	}
...
<table class="content1" width="100%" id="MyTable" cellspacing="0">
	<tbody><tr><td width="100" align="left" id="file">file</td><td>
	<input type="file" name="upgradeFile" size="20" class="filestyle">&nbsp;&nbsp;
	</td></tr>
	<tr><td width="100" align="left" id="currenttype">Current system version</td><td>
		<script>document.write( FirwareVerion+"Date of issue:"+FirwareDate )</script></td></tr>
